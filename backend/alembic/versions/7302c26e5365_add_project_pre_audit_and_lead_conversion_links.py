...
def upgrade() -> None:
    ...
    op.create_foreign_key('fk_lead_documents_file_upload_id', 'lead_documents', 'file_uploads', ['file_upload_id'], ['id'])
    op.add_column('leads', sa.Column('converted_project_id', sa.UUID(), nullable=True))
    op.create_foreign_key('fk_leads_converted_project_id', 'leads', 'projects', ['converted_project_id'], ['id'], ondelete='SET NULL')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('fk_leads_converted_project_id', 'leads', type_='foreignkey')
    op.drop_column('leads', 'converted_project_id')
    op.drop_constraint('fk_lead_documents_file_upload_id', 'lead_documents', type_='foreignkey')
